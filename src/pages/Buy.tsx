  ...
  return (
    <div>
      ...
      <div className="range-dual relative h-[24px]">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 h-[4px] rounded-full bg-bg-brand" style={{ left: `calc(${pct(low)} * (100% - 40px) / 100 + 20px)`, right: `calc(${100 - pct(high)} * (100% - 40px) / 100 + 20px)` }} />
