...
export default function Sell() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero */}
      <PageHero image={imgSellHero} imagePosition="75% 35%" title={<>Sell your car the<br />smartest way.</>} subtitle="Fill in your details and book a free inspection — we handle the rest." />
