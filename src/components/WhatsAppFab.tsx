import { PHONE_TEL, whatsappLink } from "../lib/contactInfo";

const WHATSAPP_MESSAGE = "Hi AG Cars, I'd like to know more about your cars.";

export default function WhatsAppFab() {
  return (
    <>
    {/* Phones and tablets: one-tap call, stacked above WhatsApp */}
    <a
      href={`tel:${PHONE_TEL}`}
      aria-label="Call us"
    ...
    >
      ...
      <svg viewBox="0 0 24 24" width="30" height="30" fill="currentColor" aria-hidden="true" className="relative">
